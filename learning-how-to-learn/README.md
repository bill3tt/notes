...
- [Week 3 - Procrastination and Memory](#week-3---procrastination-and-memory)
  ...
  * [Zombies](#zombies)
    ...
    + [Harnessing your Zombies](#harnessing-your-zombies)
      - [The Cue](#the-cue)
...
Learning to avoid procrastination is important because good learning is a bit by bit strategy and not cramming.

Willpower is hard to come by and uses a lot of nueral resources.

1. We procrastinate about something that makes us feel uncofortable. Pain centerns light up.
2. Funnel your attention into a more enjoyable task.
3. Feel happy (temporarily) - long term effects of habitual avoidance are nasty.

Procrastination shares features with addiction. Temporary excitement and relief from boring reality. 

It is easy to fool yourself to think the best use of any moment is to surf the web over practicing a problem.

The higher you go in your studies the more important it is to develop strategies to deal with procrastination.

## Zombies

Habit is an energy saving mechanism for us. Allows us to free our mind for other activities.

You don't have to think in a focused manner about what you're doing while you're performing the habit.

Habits have 4 parts:
* The cue - This sends you into the zombie mode. Neither helpful nor harmful.
* The routine - The routine habitual response your brain is used to falling into when it receives the cue.
* The reward - Every habit develops because it rewards us - and immediate feeling of pleasure.
* The belief - Habits have power becuase of our belief in them. To change a habit you need to chage the underlying belief.

### Process Versus Product

You can use mental tools and techniques to prevent procrastination.

When you start out on a learning session it is perfectly normal to start with a few negative feelings about starting a learning session.

Helpful to reframe thinking in terms of process not product.

* Process - "I'm going to spend 20 mins working"
* Product - "I'm going to finish my homework assignment"

To prevent procrastination, avoid concerntrating on product, attention should focus on building process.

Processes relate to simple habits that allow you to get seemingly unpleasant tasks done.

Product is the thing that causes the pain that leads you to procrastinate.

One of the easiest way to focus on process is focus on completing a pommodoro.

By focusing on process not product, you prevent yourself from judging yourself and relax into the flow of the work.

Distractions will inveitably happen, you need to learn to just let it flow by. 

### Harnessing your Zombies

You don't want to do a full scale change of old habits, just override parts of them & develop some new ones.

The trick to overriding a habit is changing your reaction to a cue. This is the only place you need to apply willpower.
...
Because procrastinations is an automatic habit, you are often unawares that you have started to procrastinate.

#### The Routine

The key to rewiring and not entering procrastination is to have a plan.

Your plan may not work perfectly at first, but keep at it, and savour the times when the plan does work.

#### The Reward

Bigger reward for a bigger achievement.

Habits are powerful because they create a neurological craving.

Only when you brain starts expecting that reward will the important rewiring take place that let you create a new habit.
...
You will find that when the going gets tough, you long to fall back into an old & comfortable habit.

Belief that your new system works is what can get you through.

### Juggling life and learning

Write a brief weekly list of key tasks in a planner journal.

Each day write a daily list the night before. Research has shown that this helps your subconcious to grapple with the tasks on that list.

If you don't write your tasks down they can lurk at the edge of the four slots of working memory and take up valuable mental real estate.

Planning your quitting time is the most important item on the list.

Those who are committed to maintaining healthy leisure time along with hard work outperform those who puruse the endless treadmill at work.

"Eat your frogs first" - work on your most important and most difficult item first.

## Memory

Evolutionary needs helped lock in a superior "where things are" and "how they look" memory system.

Images are so important to memory because images connect directly to your brains visual spatial centers. Image helps you encapsulate a seemingly boring concept into visual areas with enhanced memory capabilities.

The more 'neural hooks' you have the easier it is to recall what the concept means.

Repition is important - it helps get the memorable item lodged into long term memory.

Writing and saying what you are trying to learn seems to improve retention.

Hand writing appears to more deeply encode concepts into memory.
